...
class PoliticianController extends Controller
{
    ...
    public function createCampaign(CreateCampaignRequest $request, Politician $politician): JsonResponse
    {
        ...
        $validated['revenue_per_view']             = (float) PlatformSettingsService::get('revenue_per_view');
        $validated['voter_payout_per_view']        = (float) PlatformSettingsService::get('viewer_payout_per_view');
        $validated['head_enterprises_fee_percent'] = (float) PlatformSettingsService::get('head_enterprises_fee_percent');
