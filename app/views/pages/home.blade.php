...
@section('content')
  ...
  <main class="bs-docs-masthead" id="content" role="main">
    <div class="container">
      <span class="bs-docs-booticon bs-docs-booticon-lg "><img src="{{asset('images/d4d.lg-logo.jpg')}}" alt="logo"/></span>
      <p class="lead">Get paid up to $1.75 reviewing AdDials</p>
      <p class="lead">
