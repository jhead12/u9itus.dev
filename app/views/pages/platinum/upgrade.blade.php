...
<div class="platinum-form">
    ...
    <div class="jumbotron">
        <h1>Platinum Upgrade</h1>
        <h3 style="color: white">$100 a Year.</h3>

    </div>
     <ul class="pager">
          <li class="previous"><a href="{{URL::to('upgrade')}}">&larr; back </a></li>
...
<div class="tab-content">
  ...
  <div class="tab-pane active" id="cc"> 
    ...
    <form id="platinum"  action="{{URL::route('platinum-upgrade-post')}}" method="POST" id="payment-form">
<div class="row">
...
<fieldset><legend>Mailing Address</legend>
  ...
  <div class="small-12 large-4">
    <label for="payapl">You will be paid to this paypal email address.</label>
    <input type="text" disabled value="{{Auth::user()->Paypal_email}}">
  </div>
  ...
  <script>
    ...
    //             Will send to Post Create Platinum jsValidate
               ...
               // $('.submit-button').text(submitInitialText);
                ...
                $.ajax({
                    headers: {'X-CSRF-Token' : token},
                    url:'http://localhost/platinum/upgrade',
                    data: response,
                    type:'post',
                    success:function(data){
    ...
    //             Will send to Post Create Platinum jsValidate
                    headers: {'X-CSRF-Token' : token},
                    url: 'https://localhost/platinum/upgrade/post',
                    type: 'post',
