...
final class OfficeGlossary
{
    ...
    public const ENTRIES = [
        ...
        'superintendent-of-public-instruction' => ['title' => 'Superintendent of Public Instruction',
            'description' => 'The state superintendent of public instruction (in some states, the state school superintendent) leads the state education agency, which oversees public K-12 schools, including academic standards, school funding, and teacher licensing. Some states elect this official; others appoint one.'],
        'insurance-commissioner' => ['title' => 'Insurance Commissioner',
            'description' => 'The insurance commissioner regulates insurance companies doing business in the state: licensing insurers and agents, reviewing rates in many states, and handling consumer complaints. Some states elect this official; others appoint one.'],
        'state-auditor' => ['title' => 'State Auditor',
            'description' => 'The state auditor reviews how state agencies spend public money, audits their accounts, and reports on waste, fraud, or mismanagement.'],
        'agriculture-commissioner' => ['title' => 'Agriculture Commissioner',
            'description' => 'The agriculture commissioner leads the state agriculture department, which commonly handles food-safety and farm inspections, pest and animal-disease control, and weights-and-measures standards.'],
        'labor-commissioner' => ['title' => 'Labor Commissioner',
            'description' => 'The labor commissioner leads the state labor department, which commonly enforces wage-and-hour and workplace laws.'],
        'land-commissioner' => ['title' => 'Land Commissioner',
            'description' => 'The land commissioner manages state-owned public lands and the leases on them, such as for grazing, mining, or energy. That revenue often helps fund public schools.'],
        'board-of-equalization' => ['title' => 'Board of Equalization',
            'description' => 'Board of equalization members oversee certain state taxes and may hear some tax appeals. Their duties vary widely by state.'],
        'state-legislature' => ['title' => 'State Legislature',
            'description' => 'State legislators (state senators, and state representatives or assembly members) write state laws and pass the state budget. Each represents one legislative district, not the whole state.'],
    ...
    public static function statewideRoles(): array
    {
        return [
            ...
            ...collect(['Governor' => 'governor', 'Lieutenant Governor' => 'lieutenant-governor', 'Attorney General' => 'attorney-general',
                ...
                'Superintendent of Public Instruction' => 'superintendent-of-public-instruction', 'Insurance Commissioner' => 'insurance-commissioner',
                'State Auditor' => 'state-auditor', 'Agriculture Commissioner' => 'agriculture-commissioner', 'Labor Commissioner' => 'labor-commissioner',
                'Land Commissioner' => 'land-commissioner', 'Board of Equalization' => 'board-of-equalization', 'State Legislature' => 'state-legislature',
    ...
    public static function for(?string $office): ?array
    {
        ...
        $slug = match (true) {
            ...
            $office === 'superintendent of public instruction' => 'superintendent-of-public-instruction',
            $office === 'insurance commissioner' => 'insurance-commissioner',
            $office === 'state auditor' => 'state-auditor',
            $office === 'agriculture commissioner' => 'agriculture-commissioner',
            $office === 'labor commissioner' => 'labor-commissioner',
            $office === 'land commissioner' => 'land-commissioner',
            $office === 'board of equalization' => 'board-of-equalization',
            $office === 'mayor' => 'mayor',
