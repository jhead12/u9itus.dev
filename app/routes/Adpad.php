...
Route::get('/addial-create',array(
    'as'    => 'addial-create',
    'uses'  => 'AddialsController@create'
));



Route::get('/thecorner',array(

    'as'    =>'adcorner-start',
    'uses'  =>'ProfileController@getAdCorner'
));
...
Route::post('/call', function()
{
    ...
    $host = parse_url(Request::url(), PHP_URL_HOST); //PHP_URL_HOST DIALPAD
...
//   'before'=> 'auth',
// 'as'    => 'callback',
// 'uses'  => 'PhoneController@postMakecall'
// ));  
