...
| Ballot-measure funding ("Who's Funding This") | See the campaign committees supporting and opposing a measure, each with its state filer ID and a link to the filing, plus a "View official filings" link to the state's campaign finance site. Only admin-verified committee links are shown. | "Who's Funding This" section of `/voter/ballot-measures/{measure}` |
...
| Ballot-measure funding coverage | The funding section lists linked committees only; it does not yet show dollar totals or top donors, and no state finance data is imported automatically. It appears only after an admin sets the state's finance site or verifies at least one committee. |
