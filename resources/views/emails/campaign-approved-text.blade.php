...
@endif
Revenue per view: ${{ number_format($revenuePerView ?? \App\Services\PlatformSettingsService::get('revenue_per_view'), 2) }}

Voters will begin receiving secure notification tokens to watch your video. You'll be
charged ${{ number_format($revenuePerView ?? \App\Services\PlatformSettingsService::get('revenue_per_view'), 2) }} per verified full view from your credit balance.
