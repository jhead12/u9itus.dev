...
<title>Event Cancelled — {{ config('app.name', 'U9itus') }}</title>
<style>
  ...
  .logo span { color: #ef4444; font-weight: 700; }
  ...
  .highlight { color: #ef4444; font-weight: 500; }
  ...
  .btn { display: inline-block; padding: 14px 32px; background-color: #ef4444; color: #ffffff; font-size: 15px; font-weight: 600; text-decoration: none; border-radius: 10px; }
...
<div class="wrapper">
  <div class="card">
    ...
    <div class="body">
      ...
      <p>
        We're sorry — "<span class="highlight">{{ $event->title }}</span>" has been cancelled by the host.
      </p>
      ...
      <div class="info-box">
        ...
        <div class="info-row">
          <span class="info-label">Previously Scheduled</span>
      ...
      <div class="btn-wrap">
        <a href="{{ url('/') }}" class="btn">Explore Other Events →</a>
      </div>
