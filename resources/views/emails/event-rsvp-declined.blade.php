...
<title>RSVP Update — {{ config('app.name', 'U9itus') }}</title>
<style>
  ...
  .logo span { color: #f87171; font-weight: 700; }
...
<div class="wrapper">
  <div class="card">
    ...
    <div class="body">
      ...
      <h1>RSVP not approved</h1>

      <p>
        We're sorry — the host wasn't able to approve your RSVP for "<span class="highlight">{{ $event->title }}</span>".
      </p>
