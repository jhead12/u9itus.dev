...
<title>Event Reminder — {{ config('app.name', 'U9itus') }}</title>
<style>
...
<div class="wrapper">
  <div class="card">
    ...
    <div class="body">
      ...
      <p>
        "<span class="highlight">{{ $event->title }}</span>" starts in
        <span class="highlight">{{ $hoursUntilStart }} hour{{ $hoursUntilStart === 1 ? '' : 's' }}</span>.
      </p>
      ...
      <p style="font-size:13px">
        Need to update your RSVP? Visit the event page above.
      </p>
    </div>
