...
<div class="max-w-3xl mx-auto px-4 py-8 space-y-6 text-slate-200">
    ...
    <section class="rounded-xl border border-slate-700 p-5 space-y-4">
        ...
        <a class="inline-block rounded-lg bg-emerald-600 px-5 py-3 font-semibold text-white" href="{{ asset('downloads/u9itus-source-clipper-0.2.0.zip') }}" download>Download Source Clipper 0.2.0</a>
    ...
    <section class="rounded-xl border border-slate-700 p-5 space-y-3">
        ...
        <p class="text-sm text-slate-300">Loading it as an unpacked extension may not show a separate permission pop-up the way installing from a store would — here is exactly what its permissions do and don't allow.</p>
        <dl class="text-sm text-slate-300 space-y-3">
            ...
            <div>
                <dt class="font-semibold text-white"><code>contextMenus</code></dt>
                <dd class="text-slate-400">Adds the <strong>Clip to U9itus</strong> right-click option. It's the same trigger as clicking the toolbar icon — it only runs when you invoke it, on the page you right-clicked, and cannot act on its own.</dd>
            </div>
        </dl>
        <p class="text-sm text-slate-300">It does <strong>not</strong> ask for access to your browsing history, other websites, cookies, saved passwords, or the ability to run continuously in the background — it has no permissions beyond those three, and cannot act unless you click its icon or its right-click menu item.</p>
    ...
    <section class="space-y-3">
        ...
        <ol class="list-decimal pl-6 space-y-2">
            ...
            <li>Click the extension's toolbar icon, <strong>or</strong> right-click the page (or your selection) and choose <strong>Clip to U9itus</strong> — either opens the same review screen.</li>
            <li>Review the link, suggested headline, and excerpt. Confirm the content is public.</li>
