...
<div class="space-y-6">
    ...
    <div class="grid sm:grid-cols-3 gap-4">
        ...
        <div class="grid sm:grid-cols-3 gap-4">
            ...
            <p class="text-xs text-slate-500 mt-2">Used to fund active campaigns at ${{ number_format((float) \App\Services\PlatformSettingsService::get('revenue_per_view'), 2) }}/view</p>
        </div>
