...
<div class="px-4 sm:px-6 lg:px-8 py-8 max-w-4xl mx-auto space-y-7">
    ...
    <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-6 space-y-5">
        ...
        {{-- Voter link --}}
        <div>
            <p class="text-sm font-medium text-emerald-400 mb-1.5">Voter Registration Link</p>
            <p class="text-slate-400 text-xs mb-2">Earn $0.025 per view forever for every voter you refer.</p>
            ...
            <p id="voter-copy-confirm" class="text-emerald-400 text-xs mt-1.5 hidden">✓ Copied!</p>
        </div>

        {{-- Politician link --}}
        <div>
            <p class="text-sm font-medium text-amber-400 mb-1.5">Politician Registration Link</p>
            <p class="text-slate-400 text-xs mb-2">Earn 10% of the first credit purchase when a politician you recruit funds their campaign.</p>
            <div class="flex gap-2">
            ...
            <p id="politician-copy-confirm" class="text-amber-400 text-xs mt-1.5 hidden">✓ Copied!</p>
        </div>
    </div>
...
@push('scripts')
<script>
function copyLink(inputId, confirmId) {
