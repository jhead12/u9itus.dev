...
<div class="px-6 py-8 max-w-3xl mx-auto">
    <h1 class="text-2xl font-bold text-white mb-8">New Topic</h1>
    ...
    <form method="POST" action="{{ route('admin.topics.store') }}" class="space-y-6">
        @include('standalone.admin.topics._form')
    </form>
</div>
@endsection
