...
@section('title', 'New Ballot Measure')
@section('page-title', 'Ballot Measures')

@section('content')
<div class="px-6 py-8 max-w-3xl mx-auto">
    <h1 class="text-2xl font-bold text-white mb-8">New Ballot Measure</h1>
    ...
    <form method="POST" action="{{ route('admin.ballot-measures.store') }}" class="space-y-6">
