...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        ...
        <div class="stat-card">
            ...
            @endif
            <p class="text-xs text-slate-500 mt-0.5">${{ number_format($stats['total_payouts'], 2) }} paid out to voters</p>
        </div>
        <div class="stat-card">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <a href="{{ route('admin.kyc.index') }}" class="bg-slate-800/50 border border-slate-700/50 hover:border-yellow-500/40 rounded-xl p-4 text-center transition group relative">
            ...
            <p class="text-xs text-slate-500 group-hover:text-slate-400 transition mt-0.5">Politicians only</p>
        </a>
