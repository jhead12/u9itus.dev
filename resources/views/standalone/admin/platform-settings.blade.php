        ...
        <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
            <div class="flex items-center gap-3 mb-3">
                ...
                <div>
                    ...
                    <p class="text-white text-2xl font-bold">${{ number_format($currentValues['revenue_per_view'] ?? \App\Services\PlatformSettingsService::get('revenue_per_view'), 2) }}</p>
                </div>
            </div>
        ...
        <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
            <div class="flex items-center gap-3 mb-3">
                ...
                <div>
                    ...
                    <p class="text-white text-2xl font-bold">${{ number_format($currentValues['viewer_payout_per_view'] ?? \App\Services\PlatformSettingsService::get('viewer_payout_per_view'), 2) }}</p>
                </div>
            </div>
