...
@php
    $citizenRatePerView     = number_format((float) \App\Services\PlatformSettingsService::get('citizen_revenue_per_view'), 2);
    $ballotIssueRatePerView = number_format((float) \App\Services\PlatformSettingsService::get('ballot_issue_revenue_per_view'), 2);
@endphp
