...
<head>
    ...
    @include('standalone.partials.seo-head', ['seoTitle' => 'District Lookup — U9itus', 'seoDescription' => 'Enter your address to find your congressional district and view verified candidates, current officeholders, and campaign finance data for your area.', 'seoCanonical' => url('/district-lookup')])
