...
export const PoliticianProfileScreen: React.FC<
    PoliticianProfileScreenProps
> = ({ campaignId: propsCampaignId, route }) => {
    const [politician, setPolitician] = useState<PoliticianProfile | null>(
        null,
    );
            ...
            >
                ...
                <View style={styles.questionsSection}>
                    <Text style={styles.sectionTitle}>
                        🎥 Voter Video Questions ({videoQuestions.length})
                    </Text>

                    {videoQuestions.length === 0 ? (
                        <View style={styles.emptyState}>
                            <Text style={styles.emptyStateText}>
                                No video questions yet.
                            </Text>
